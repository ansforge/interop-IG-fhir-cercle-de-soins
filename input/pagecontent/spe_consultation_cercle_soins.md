...
{% include spe-activity-cds-consult.svg %}
<figcaption> Diagramme d'activité du processus collaboratif "Consultation du cercle de soins"</figcaption>
</figure>
...
<figure class="figure svg-wrap" style="width:100%;">
 ...
 <p style="margin: 0; padding: 0;">
    {% include spe-flux2.svg %}
 </p>
<figcaption> Attributs sur lesquels le filtrage de recherche peut s'appliquer </figcaption>
</figure>
...
<figcaption> Diagramme des concepts contenus dans le flux 3 </figcaption>
</figure>
...
Ces critères de recherche ont été définis dans la partie [étude fonctionnelle](#flux-2---recherchecerclesoins).
