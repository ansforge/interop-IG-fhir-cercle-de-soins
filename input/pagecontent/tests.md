...
La plateforme de test [EVSClient](https://interop.esante.gouv.fr/evs/default/validator.seam?standard=30) propose un validateur FHIR par profil défini dans ce guide d'implémentation (cf onglet <a href="artifacts.html">Ressources de conformité</a>).
