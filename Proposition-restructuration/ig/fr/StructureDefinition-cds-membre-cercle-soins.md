...
## Modèle logique: CDS Membre Cercle Soins 
...
* Utilise ce/t/te Modèle logique: [CDS Cercle Soins](StructureDefinition-cds-cercle-soins.md), [CDS Contact](StructureDefinition-cds-contact.md), [CDS Entite Geographique](StructureDefinition-cds-entite-geographique.md), [CDS Organisation Interne](StructureDefinition-cds-organisation-interne.md) and [CDS Situation Exercice](StructureDefinition-cds-situation-exercice.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.cds|current/StructureDefinition/cds-membre-cercle-soins)
...
Autres représentations du profil : [CSV](../StructureDefinition-cds-membre-cercle-soins.csv), [Excel](../StructureDefinition-cds-membre-cercle-soins.xlsx) 
