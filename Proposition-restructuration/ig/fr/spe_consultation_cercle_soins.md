# Consultation du cercle de soins - Cercle De Soins v2.0.1

## Consultation du cercle de soins

### Etude fonctionnelle

Le consommateur du cercle de soins effectue une demande de consultation du cercle de soins de la personne dans le gestionnaire du cercle de soins afin de pouvoir le récupérer.
...
* Etre habilité ;
* Disposer des paramètres de la demande de consultation du cercle de soins (et en particulier de l’identifiant du patient).

**Description des actions** :

Diagramme d'activité du processus collaboratif "Consultation du cercle de soins"
...
#### Concepts métiers utilisés dans les flux 2 et 3

##### Flux 2 - RechercheCercleSoins

Le flux 2 étant un flux de recherche le diagramme suivant précise les champs sur lequel le filtrage de recherche peut s'applique pour chaque concept métier :
...
Attributs sur lesquels le filtrage de recherche peut s'appliquer
...
Diagramme des concepts contenus dans le flux 3
...
#### Recherche et récupération du cercle de soins
...
La requête GET est accompagnée des paramètres de recherches définis dans le [CapabilityStatement du Gestionnaire](CapabilityStatement-CDSGestionnaire.md). Ces critères de recherche ont été définis dans la partie [étude fonctionnelle](#flux-2---recherchecerclesoins).
